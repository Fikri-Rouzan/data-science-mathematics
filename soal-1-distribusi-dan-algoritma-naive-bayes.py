...
Original file is located at
    https://colab.research.google.com/drive/1Ch8tbxNMy33PSpOqhdoNkd8fWwtS3fet
...
def viz_uniform_teoretis(lower_bound, upper_bound, num_samples):
  ...
  random_data = generate_rand_uniform(lower_bound, upper_bound, num_samples)
  ...
  plt.hist(random_data, bins=30, density=True, color='lightgrey', edgecolor='black')
...
def binomial_inverse_cdf(probability, n_trials, success_prob):
  ...
  array = binom.ppf(q=probability, n=n_trials, p=success_prob)
...
def generate_data_synthetic(breed, features, n_samples, params):
  ...
  for feature in features:
      ...
      if feature == "wingspan_cm" or feature == "weight_g":
          df[feature] = generate_gaussian(p.miu, p.sigma, n_samples)
          ...
          df[feature] = generate_binomial(p.n_trials, p.probability, n_samples)
          ...
          df[feature] = generate_rand_uniform(p.lower_bound, p.upper_bound, n_samples)
...
def pmf_for_binomial(val, n_trials, probability):
  ...
  pmf = binom.pmf(k=val, n=n_trials, p=probability)
...
def training_params_estimation(df, features):
    ...
    for breed in df['breed']:
        ...
        probs_dict[breed] = len(df_breed) / total_samples
        ...
        for feature in features:
            ...
            if feature == "wingspan_cm" or feature == "weight_g":
                ...
                params = binomial_params(n_trials=int(n_trials), probability=p)
                ...
                params = uniform_params(lower_bound=a, upper_bound=b)
