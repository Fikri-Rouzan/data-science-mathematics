...
Original file is located at
    https://colab.research.google.com/drive/1dpbWGURzLglnd2HH_vZzjBpHCn2ka16o
...
def estimate_sample_size_proportions(p1, p2, alpha=0.05, beta=0.20, two_sided=True):
    ...
    n = np.power((term1 + term2) / delta, 2)
...
def generate_proportion_metrics(data):
  ...
  metrics = metrics_estimation(n=int(n), x=int(x), p=float(p))
